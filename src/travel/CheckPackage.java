...
public class CheckPackage extends JFrame{
    ...
    public JPanel createPackage(String[] pack){
        ...
        ImageIcon i1  = new ImageIcon("C:\\Users\\ranaa\\eclipse-workspace\\Travel management system\\src\\travel\\icons\\icons\\"+pack[0]);
        Image i3 = i1.getImage().getScaledInstance(550, 300,Image.SCALE_DEFAULT);
        ImageIcon i2 = new ImageIcon(i3);
        JLabel l1 = new JLabel(i2);
        l1.setBounds(388,0,467,420);
        p1.add(l1);

        JLabel lblName = new JLabel(pack[1]);
        lblName.setFont(new Font("Engravers MT", Font.PLAIN, 30));
        lblName.setBounds(50, 5, 419, 53);
        p1.add(lblName);

        JLabel l3 = new JLabel(pack[2]);
        l3.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        l3.setForeground(Color.RED);
        l3.setBounds(35, 70, 232, 29);
        p1.add(l3);

        JLabel lblId = new JLabel(pack[3]);
        lblId.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        lblId.setForeground(Color.BLUE);
        lblId.setBounds(35, 110, 343, 29);
        p1.add(lblId);

        JLabel l2 = new JLabel(pack[4]);
        l2.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        l2.setForeground(Color.RED);
        l2.setBounds(35, 150, 343, 29);
        p1.add(l2);

        JLabel lblName_1 = new JLabel(pack[5]);
        lblName_1.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        lblName_1.setForeground(Color.BLUE);
        lblName_1.setBounds(35, 190, 343, 29);
        p1.add(lblName_1);

        JLabel lblGender = new JLabel(pack[6]);
        lblGender.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        lblGender.setForeground(Color.RED);
        lblGender.setBounds(35, 230, 232, 29);
        p1.add(lblGender);

        JLabel lblCountry = new JLabel(pack[7]);
        lblCountry.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        lblCountry.setForeground(Color.BLUE);
        lblCountry.setBounds(35, 270, 232, 29);
        p1.add(lblCountry);

        JLabel lblReserveRoomNumber = new JLabel(pack[8]);
        lblReserveRoomNumber.setFont(new Font("Tempus Sans ITC", Font.BOLD, 16));
        lblReserveRoomNumber.setForeground(Color.RED);
        lblReserveRoomNumber.setBounds(35, 310, 232, 29);
        p1.add(lblReserveRoomNumber);

        JLabel lblCheckInStatus = new JLabel(pack[9]);
        lblCheckInStatus.setForeground(Color.BLUE);
        lblCheckInStatus.setFont(new Font("Engravers MT", Font.PLAIN, 20));
        lblCheckInStatus.setBounds(35, 400, 200, 30);
        p1.add(lblCheckInStatus);

        JLabel lblDeposite = new JLabel(pack[10]);
        lblDeposite.setFont(new Font("Engravers MT", Font.PLAIN, 30));
        lblDeposite.setBounds(35, 445, 400, 40);
        p1.add(lblDeposite);
        
        JLabel la1 = new JLabel(pack[11]);
        la1.setForeground(Color.RED);
        la1.setFont(new Font("Engravers MT", Font.PLAIN, 30));
        la1.setBounds(553, 445, 419, 40);
        p1.add(la1);
