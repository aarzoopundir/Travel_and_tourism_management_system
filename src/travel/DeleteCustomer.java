...
public class DeleteCustomer extends JFrame {
	...
	public DeleteCustomer() throws SQLException {
		...
		contentPane.setLayout(null);
                ...
                ImageIcon i1  = new ImageIcon("C:\\Users\\ranaa\\eclipse-workspace\\Travel management system\\src\\travel\\icons\\icons\\delete.png");
		...
		lblName.setFont(new Font("Colonna MT", Font.BOLD, 20));
		...
		b1.setFont(new Font("Tempus Sans ITC", Font.BOLD, 14));
		b1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                            Conn c = new Conn();
                           
                            try{
                                ResultSet rs = c.s.executeQuery("select * from customer where username = 'juli'");
                                if(rs.next()){
